...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when(view.id) {
            ...
            R.id.red_button -> box_three_text.setBackgroundColor(resources.getColor(R.color.my_red))
            R.id.yellow_button -> box_four_text.setBackgroundColor(resources.getColor(R.color.my_yellow))
            R.id.green_button -> box_five_text.setBackgroundColor(resources.getColor(R.color.my_green))
